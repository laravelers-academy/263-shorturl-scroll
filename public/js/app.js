...
__webpack_require__(/*! ./shorter */ "./resources/js/shorter.js");
...
window.paginator = _defineProperty({
  next_page_url: null,
  data: {},
  has_more: true,
  ...
  load_items: function load_items(url) {
    if (paginator.has_more) {
      axios.get(url).then(function (res) {
        var response = JSON.parse(res.data.urls);
  ...
  fill_items: function fill_items(data) {
    data.forEach(function (i, j) {
      var item_template = paginator.template;
...
__webpack_require__(/*! C:\xampp\htdocs\proyectos\laravel\shorturl\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\proyectos\laravel\shorturl\resources\css\app.css */"./resources/css/app.css");
